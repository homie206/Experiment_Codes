...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'llm-gen/{ipip_label_content_str}-generated-prompt-llama3.1-8b-instruct-output.txt'
        result_file_name = f'llm-gen/{ipip_label_content_str}-generated-prompt-llama3.1-8b-instruct-result.csv'
