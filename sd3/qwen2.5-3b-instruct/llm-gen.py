...
#Please use a paragraph to describe a human who is
prompt_template = {
    "ipip_prompt": [
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am low on Machiavellianism, low on Narcissism, low on Psychopathy.',
        'label': "['M-Low', 'N-Low', 'P-Low']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am low on Machiavellianism, low on Narcissism, high on Psychopathy.',
        'label': "['M-Low', 'N-Low', 'P-High']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am low on Machiavellianism, high on Narcissism, low on Psychopathy.',
        'label': "['M-Low', 'N-High', 'P-Low']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am low on Machiavellianism, high on Narcissism, high on Psychopathy.',
        'label': "['M-Low', 'N-High', 'P-High']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am high on Machiavellianism, low on Narcissism, low on Psychopathy.',
        'label': "['M-High', 'N-Low', 'P-Low']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am high on Machiavellianism, low on Narcissism, high on Psychopathy.',
        'label': "['M-High', 'N-Low', 'P-High']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am high on Machiavellianism, high on Narcissism, low on Psychopathy.',
        'label': "['M-High', 'N-High', 'P-Low']"},
        {'prompt': 'Directly output one paragraph to describe my personality in Short Dark Triads, I am high on Machiavellianism, high on Narcissism, high on Psychopathy.',
...
def get_response(question, gen_prompt,tokenizer,model):

    messages = [
        {"role": "system", "content": "Imagine you are a human. " + gen_prompt},
...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'llm-gen/{ipip_label_content_str}-generated-prompt-qwen2.5-3b-instruct-output.txt'
        result_file_name = f'llm-gen/{ipip_label_content_str}-generated-prompt-qwen2.5-3b-instruct-result.csv'
            ...
            with open('../sd3.txt', 'r') as f2:
                ...
                for run in range(10):  # 运行100次
                    ...
                    for q in question_list:
                        answer = get_response(question = q, gen_prompt = generated_prompt, tokenizer = tokenizer, model = model)
                        f.write(answer + '\n')
