...
def main_run():
    ...
    for itr in range(10):
        ...
        for item in test_template["combinations"]:
            ...
            result_file_name = f'our_method/result_iteration_{itr + 1}/result-generate-{label_content_str}-sd3-qwen2.5-3b-instruct-result.csv'
            ...
            with open(output_file_name, 'a', encoding='utf-8') as f, open(result_file_name, 'a', encoding='utf-8') as r:
                with open('../sd3.txt', 'r') as f2:
                    ...
                    for q in question_list:
                        ...
                        answer = get_response(question=q, tokenizer= tokenizer, prompt=item["prompt"],
                                              prompt_by_words=prompt_by_words, model = model_qw)
