...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'vanilla/{ipip_label_content_str}-vanilla-sd3-qwen2-vl-72b-instruct-output.txt'
        result_file_name = f'vanilla/{ipip_label_content_str}-vanilla-sd3-qwen2-vl-72b-instruct-result.csv'
            ...
            with open('../sd3.txt', 'r') as f2:
                ...
                for run in range(10):  # 运行100次
                    ...
                    for q in question_list:
                        answer = generateResponse(client,ipip_prompt,q)
