...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'combine/{ipip_label_content_str}-vanilla-sd3-qwen2.5-72b-instruct-output.txt'
        result_file_name = f'combine/{ipip_label_content_str}-vanilla-sd3-qwen2.5-72b-instruct-result.csv'
