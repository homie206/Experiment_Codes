...
def main_run(model_id):
    for itr in range(10):
        ...
        for item in test_template["combinations"]:
            ...
            output_file_name = f'our_method/result_iteration_{itr + 1}/result-generate-{label_content_str}-bfi44-llama3.1-8b-instruct-output.txt'
            result_file_name = f'our_method/result_iteration_{itr + 1}/result-generate-{label_content_str}-bfi44-llama3.1-8b-instruct-result.csv'
            ...
            with open(output_file_name, 'a', encoding='utf-8') as f, open(result_file_name, 'a', encoding='utf-8') as r:
                with open('../bfi44.txt', 'r') as f2:
                    ...
                    for q in question_list:
                        ...
                        answer = get_response(question=q, pip_line=pipeline, prompt= item["prompt"], prompt_by_words= prompt_by_words)
