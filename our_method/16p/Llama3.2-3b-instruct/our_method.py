...
def main_run(model_id):
    for itr in range(10):
        ...
        for item in test_template["combinations"]:
            ...
            result_file_name = f'our_method/result_iteration_{itr + 1}/result-generated-{label_content_str}-16p-llama3.2-3b-instruct-result.csv'
            ...
            with open(output_file_name, 'a', encoding='utf-8') as f, open(result_file_name, 'a', encoding='utf-8') as r:
                ...
                for question_num, question in mbti_questions.items():
                    response = get_response(question=question, pip_line=pipeline, gen_prompt= mbti_16p_prompt)
