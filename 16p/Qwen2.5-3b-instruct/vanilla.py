...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-qwen2.5-3b-instruct-output.txt'
        result_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-qwen2.5-3b-instruct-result.csv'
