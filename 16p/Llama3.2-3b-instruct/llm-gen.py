...
def get_response_answer(question, pip_line, gen_prompt):
    pipeline = pip_line
...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'llm-gen/{mbti_label_content}-generated-prompt-induce-mbti-llama3.2-3b-instruct-output.txt'
        result_file_name = f'llm-gen/{mbti_label_content}-generated-prompt-induce-mbti-llama3.2-3b-instruct-result.csv'
