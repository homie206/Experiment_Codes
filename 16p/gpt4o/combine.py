...
def get_model_examing_result():
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-gpt-4o-output.txt'
        result_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-gpt-4o-result.csv'
        ...
        with open(output_file_name, 'a', encoding='utf-8') as f, open(result_file_name, 'a',
            ...
            for cycle in range(1, 11):
                ...
                for question_num, question in mbti_questions.items():
                    ...
                    generated_text = generateResponse(mbti_prompt, question)
