...
def get_model_examing_result(client_qw):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-qwen2-vl-72b-instruct-output.txt'
        result_file_name = f'vanilla/{mbti_label_content}-vanilla-induce-mbti-qwen2-vl-72b-instruct-result.csv'
...
if __name__ == '__main__':
    ...
    #get_single_dim_model_examing_result(client)
